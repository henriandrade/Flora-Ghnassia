...
)`),R_=RegExp("".concat(Ml,"(?=").concat(Ml,")|").concat(w_).concat(A_),"g"),C_=[Kh,Oc,Wh,Xh,$h],P_=RegExp("[".concat(C_.join(""),"]"));function D_(i){return i.split("")}function Qh(i){return P_.test(i)}function L_(i){return i.match(R_)||[]}function U_(i){return Qh(i)?L_(i):D_(i)}function I_(i){return i==null?"":String(i)}function N_(i){var t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:"";return i=I_(i),i&&Ys(i)&&!t&&Qh(i)?U_(i):i.split(t)}function yl(i,t){var e=document.createElement(i);return t&&Object.keys(t).forEach(function(n){var r=t[n],s=Ys(r)?r.trim():r;s===null||s===""||(n==="children"?e.append.apply(e,Be(lr(s))):e.setAttribute(n,s))}),e}var Bc={splitClass:"",lineClass:"line",wordClass:"word",charClass:"char",types:["lines","words","chars"],absolute:!1,tagName:"div"};function F_(i,t){t=Zi(Bc,t);var e=Fc(t.types),n=t.tagName,r=i.nodeValue,s=document.createDocumentFragment(),a=[],o=[];return/^\s/.test(r)&&s.append(" "),a=y_(r).reduce(function(l,c,u,f){var h,d;return e.chars&&(d=N_(c).map(function(g){var _=yl(n,{class:"".concat(t.splitClass," ").concat(t.charClass),style:"display: inline-block;",children:g});return On(_,"isChar",!0),o=[].concat(Be(o),[_]),_})),e.words||e.lines?(h=yl(n,{class:"".concat(t.wordClass," ").concat(t.splitClass),style:"display: inline-block; ".concat(e.words&&t.absolute?"position: relative;":""),children:e.chars?d:c}),On(h,{isWord:!0,isWordStart:!0,isWordEnd:!0}),s.appendChild(h)):d.forEach(function(g){s.appendChild(g)}),u<f.length-1&&s.append(" "),e.words?l.concat(h):l},[]),/\s$/.test(r)&&s.append(" "),i.replaceWith(s),{words:a,chars:o}}function td(i,t){var e=i.nodeType,n={words:[],chars:[]};if(!/(1|3|11)/.test(e))return n;if(e===3&&/\S/.test(i.nodeValue))return F_(i,t);var r=lr(i.childNodes);if(r.length&&(On(i,"isSplit",!0),!Ji(i).isRoot)){i.style.display="inline-block",i.style.position="relative";var s=i.nextSibling,a=i.previousSibling,o=i.textContent||"",l=s?s.textContent:" ",c=a?a.textContent:" ";On(i,{isWordEnd:/\s$/.test(o)||/^\s/.test(l),isWordStart:/^\s/.test(o)||/\s$/.test(c)})}return r.reduce(function(u,f){var h=td(f,t),d=h.words,g=h.chars;return{words:[].concat(Be(u.words),Be(d)),chars:[].concat(Be(u.chars),Be(g))}},n)}function O_(i,t,e,n){if(!e.absolute)return{top:t?i.offsetTop:null};var r=i.offsetParent,s=Hh(n,2),a=s[0],o=s[1],l=0,c=0;if(r&&r!==document.body){var u=r.getBoundingClientRect();l=u.x+a,c=u.y+o}var f=i.getBoundingClientRect(),h=f.width,d=f.height,g=f.x,_=f.y,m=_+o-c,p=g+a-l;return{width:h,height:d,top:m,left:p}}function ed(i){Ji(i).isWord?(Gh(i),i.replaceWith.apply(i,Be(i.childNodes))):lr(i.children).forEach(function(t){return ed(t)})}var B_=function(){return document.createDocumentFragment()};function z_(i,t,e){var n=Fc(t.types),r=t.tagName,s=i.getElementsByTagName("*"),a=[],o=[],l=null,c,u,f,h=[],d=i.parentElement,g=i.nextElementSibling,_=B_(),m=window.getComputedStyle(i),p=m.textAlign,T=parseFloat(m.fontSize),y=T*.2;return t.absolute&&(f={left:i.offsetLeft,top:i.offsetTop,width:i.offsetWidth},u=i.offsetWidth,c=i.offsetHeight,On(i,{cssWidth:i.style.width,cssHeight:i.style.height})),lr(s).forEach(function(v){var b=v.parentElement===i,A=O_(v,b,t,e),w=A.width,C=A.height,x=A.top,M=A.left;/^br$/i.test(v.nodeName)||(n.lines&&b&&((l===null||x-l>=y)&&(l=x,a.push(o=[])),o.push(v)),t.absolute&&On(v,{top:x,left:M,width:w,height:C}))}),d&&d.removeChild(i),n.lines&&(h=a.map(function(v){var b=yl(r,{class:"".concat(t.splitClass," ").concat(t.lineClass),style:"display: block; text-align: ".concat(p,"; width: 100%;")});On(b,"isLine",!0);var A={height:0,top:1e4};return _.appendChild(b),v.forEach(function(w,C,x){var M=Ji(w),P=M.isWordEnd,O=M.top,N=M.height,X=x[C+1];A.height=Math.max(A.height,N),A.top=Math.min(A.top,O),b.appendChild(w),P&&Ji(X).isWordStart&&b.append(" ")}),t.absolute&&On(b,{height:A.height,top:A.top}),b}),n.words||ed(_),i.replaceChildren(_)),t.absolute&&(i.style.width="".concat(i.style.width||u,"px"),i.style.height="".concat(c,"px"),lr(s).forEach(function(v){var b=Ji(v),A=b.isLine,w=b.top,C=b.left,x=b.width,M=b.height,P=Ji(v.parentElement),O=!A&&P.isLine;v.style.top="".concat(O?w-P.top:w,"px"),v.style.left=A?"".concat(f.left,"px"):"".concat(C-(O?f.left:0),"px"),v.style.height="".concat(M,"px"),v.style.width=A?"".concat(f.width,"px"):"".concat(x,"px"),v.style.position="absolute"})),d&&(g?d.insertBefore(i,g):d.appendChild(i)),h}var vr=Zi(Bc,{}),La=function(){Nu(i,null,[{key:"clearData",value:function(){S_()}},{key:"setDefaults",value:function(e){return vr=Zi(vr,ra(e)),Bc}},{key:"revert",value:function(e){Bu(e).forEach(function(n){var r=Ji(n),s=r.isSplit,a=r.html,o=r.cssWidth,l=r.cssHeight;s&&(n.innerHTML=a,n.style.width=o||"",n.style.height=l||"",Gh(n))})}},{key:"create",value:function(e,n){return new i(e,n)}},{key:"data",get:function(){return Cn}},{key:"defaults",get:function(){return vr},set:function(e){vr=Zi(vr,ra(e))}}]);function i(t,e){o_(this,i),this.isSplit=!1,this.settings=Zi(vr,ra(e)),this.elements=Bu(t),this.split()}return Nu(i,[{key:"split",value:function(e){var n=this;this.revert(),this.elements.forEach(function(a){On(a,"html",a.innerHTML)}),this.lines=[],this.words=[],this.chars=[];var r=[window.pageXOffset,window.pageYOffset];e!==void 0&&(this.settings=Zi(this.settings,ra(e)));var s=Fc(this.settings.types);s.none||(this.elements.forEach(function(a){On(a,"isRoot",!0);var o=td(a,n.settings),l=o.words,c=o.chars;n.words=[].concat(Be(n.words),Be(l)),n.chars=[].concat(Be(n.chars),Be(c))}),this.elements.forEach(function(a){if(s.lines||n.settings.absolute){var o=z_(a,n.settings,r);n.lines=[].concat(Be(n.lines),Be(o))}}),this.isSplit=!0,window.scrollTo(r[0],r[1]),M_())}},{key:"revert",value:function(){this.isSplit&&(this.lines=null,this.words=null,this.chars=null,this.isSplit=!1),i.revert(this.elements)}}]),i}();function Zn(i){if(i===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return i}function nd(i,t){i.prototype=Object.create(t.prototype),i.prototype.constructor=i,i.__proto__=t}/*!
 * GSAP 3.12.7
 * https://gsap.com
 *
...
#define LOW_PRECISION`),t}function Fy(i){let t="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===ap?t="SHADOWMAP_TYPE_PCF":i.shadowMapType===dv?t="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===Kn&&(t="SHADOWMAP_TYPE_VSM"),t}function Oy(i){let t="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case rs:case ss:t="ENVMAP_TYPE_CUBE";break;case vo:t="ENVMAP_TYPE_CUBE_UV";break}return t}function By(i){let t="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case ss:t="ENVMAP_MODE_REFRACTION";break}return t}function zy(i){let t="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case op:t="ENVMAP_BLENDING_MULTIPLY";break;case Lv:t="ENVMAP_BLENDING_MIX";break;case Uv:t="ENVMAP_BLENDING_ADD";break}return t}function ky(i){const t=i.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function Hy(i,t,e,n){const r=i.getContext(),s=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=Fy(e),c=Oy(e),u=By(e),f=zy(e),h=ky(e),d=Ry(e),g=Cy(s),_=r.createProgram();let m,p,T=e.glslVersion?"#version "+e.glslVersion+`
